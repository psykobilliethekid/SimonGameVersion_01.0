var game = { //game object
  ...
  loadSounds: function () {
    var self = this;
    this.soundPlayer = new BufferLoader([
      'sounds/mp3/sounds_01.mp3',
      'sounds/mp3/sounds_02.mp3',
      'sounds/mp3/sounds_03.mp3',
      'sounds/mp3/sounds_04.mp3'
    ], function (data) {
      $('.shape1').on('click', function () {
        self.soundPlayer.play(0);
      });
      $('.shape2').on('click', function () {
        self.soundPlayer.play(1);
      });
      $('.shape3').on('click', function () {
        self.soundPlayer.play(2);
      });
      $('.shape4').on('click', function () {
        self.soundPlayer.play(3);
      });
    });
